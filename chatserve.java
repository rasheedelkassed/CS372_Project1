...
* Project Number 1                
* Due Date: 10/28/2018
* Description: The server side of a chat program that is able to accept and talk to one
* client. It is able to send 500 characters and will stop when "\quit" is typed
*
